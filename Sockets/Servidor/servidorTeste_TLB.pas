...
// $Rev: 8291 $
// File generated on 29/10/2013 16:05:46 from Type Library described below.
...
const
  ...
  IID_IConsulta: TGUID = '{6FD2094D-B9D7-46B5-87ED-E97CA2A3F0FB}';
  CLASS_Consulta: TGUID = '{A51279DE-9BA9-4BC1-BF47-D0BBBEF116E9}';
type
...
// Interface: IConsulta
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {6FD2094D-B9D7-46B5-87ED-E97CA2A3F0FB}
// *********************************************************************//
  IConsulta = interface(IAppServer)
    ['{6FD2094D-B9D7-46B5-87ED-E97CA2A3F0FB}']
  end;

// *********************************************************************//
// DispIntf:  IConsultaDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {6FD2094D-B9D7-46B5-87ED-E97CA2A3F0FB}
// *********************************************************************//
  IConsultaDisp = dispinterface
...
// *********************************************************************//
// The Class CoConsulta provides a Create and CreateRemote method to          
// create instances of the default interface IConsulta exposed by              
// the CoClass Consulta. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoConsulta = class
    class function Create: IConsulta;
    class function CreateRemote(const MachineName: string): IConsulta;
  end;
...
class function CoConsulta.Create: IConsulta;
begin
  Result := CreateComObject(CLASS_Consulta) as IConsulta;
end;

class function CoConsulta.CreateRemote(const MachineName: string): IConsulta;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Consulta) as IConsulta;
end;
